...
public class ExploreProfileDetailResponse {
    ...
    public static ExploreProfileDetailResponse of(
        ...
        return ExploreProfileDetailResponse.builder()
                ...
                .emojiIntro(lifestyle != null ? lifestyle.getEmojiIntro() : null)
                .mbti(lifestyle != null ? lifestyle.getMbti() : null)
                .hobbies(hobbies.stream().map(UserHobby::getHobby).toList())
                .lifestyle(lifestyle != null ? LifestyleDto.builder()
                        .drinking(lifestyle.getDrinking() != null ? lifestyle.getDrinking().name() : null)
                        .smoking(lifestyle.getSmoking() != null ? lifestyle.getSmoking().name() : null)
                        .exercise(lifestyle.getExercise() != null ? lifestyle.getExercise().name() : null)
                        .build() : null)
                .datingStyle(datingStyle != null ? DatingStyleDto.builder()
                        .purpose(datingStyle.getPurpose() != null ? datingStyle.getPurpose().name() : null)
                        .contactStyle(datingStyle.getContactStyle() != null ? datingStyle.getContactStyle().name() : null)
                        .dateStyle(datingStyle.getDateStyle() != null ? datingStyle.getDateStyle().name() : null)
                        .personalTime(datingStyle.getPersonalTime() != null ? datingStyle.getPersonalTime().name() : null)
                        .build() : null)
